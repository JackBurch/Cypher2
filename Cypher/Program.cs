...
namespace CeaserCypher
{
    ...
    /// 
    /// </summary>
    /// the summary is a format for commenting
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Would you like to decrypt or encrypt a message? 1 or 2");
            ...
            if (decrypt == '1')
            {
                ...
                int Key = Convert.ToInt16(Console.ReadKey().KeyChar);
